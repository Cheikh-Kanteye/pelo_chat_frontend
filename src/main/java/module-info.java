module com.example.pelo_chat {
    ...
    requires javafx.graphics;      // ← AJOUTER
    ...
    opens com.example.pelo_chat.model to com.google.gson;    // ← AJOUTER
    opens com.example.pelo_chat.service to javafx.fxml;      // ← AJOUTER
