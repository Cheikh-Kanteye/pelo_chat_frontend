...
public class ChatController {
    ...
    public void init(String username, SocketService service) {
        ...
        // Note: statusLabel is removed in new UI layout
        // statusLabel.setText("Connecté en tant que : " + username);
    }

    private void handlePacket(Packet packet) {
        // Logique à adapter avec le nouveau messageContainer
        /*
    ...
    @FXML
    private void onSend() {
        // Logique à adapter (recipientField est supprimé dans cette version statique)
        /*
